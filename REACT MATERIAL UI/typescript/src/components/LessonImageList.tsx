...
<ImageList sx={{width:900,height:900}} rowHeight={250} cols={3}>
    {itemData.map((item)=>(
    <ImageListItem key={item.img}><img src={item.img} loading="lazy"/><ImageListItemBar title={item.title}/></ImageListItem>
    ))}
</ImageList>

<ImageList variant="woven" sx={{width:900,height:900}} rowHeight={250} cols={3}>
    {itemData.map((item)=>(
    <ImageListItem key={item.img}><img src={item.img} loading="lazy"/></ImageListItem>
    ))}
</ImageList>

<ImageList variant="masonry" sx={{width:900,height:900}} rowHeight={250} cols={3}>
    {itemData.map((item)=>(
    <ImageListItem key={item.img}><img src={item.img} loading="lazy"/></ImageListItem>
    ))}
</ImageList>
