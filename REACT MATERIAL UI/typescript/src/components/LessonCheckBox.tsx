    ...
    <Box>
      ...
      <Box>
        <FormControl>
          ...
          <FormGroup row>
            <FormControlLabel value="react" control={<Checkbox checked={knowlegde.includes('react')} onChange={handleKnowlegdeChange}/>} label="React Js" />
            <FormControlLabel value="angular" control={<Checkbox checked={knowlegde.includes('angular')} onChange={handleKnowlegdeChange}/>} label="Angular"/>
            <FormControlLabel value="vue" control={<Checkbox checked={knowlegde.includes('vue')} onChange={handleKnowlegdeChange}/>} label="Vue Js"/>
          </FormGroup>
        </FormControl>
      </Box>
    </Box>
